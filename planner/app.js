  ...
  return `
    <section class="settings-grid">
      <div class="view-panel">
        ...
        <div class="button-row" style="margin-top:14px"><button class="ghost-button" data-action="google-sign-out">${icon("signOut")}Sign out</button><button class="ghost-button" data-action="google-bootstrap">${icon("refresh")}Re-sync Drive</button><button class="ghost-button" data-action="sync-all-folders">${icon("folder")}Sync all folders</button><button class="ghost-button" data-action="refresh-categories">${icon("refresh")}Refresh categories</button></div>
      </div>
      <div class="view-panel">
